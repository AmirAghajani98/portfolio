    ...
    <div className="relative mx-auto flex w-full max-w-lg items-center justify-center">
      ...
      >
        <Link
          ...
          className="p-2.5 sm:mr-1 mt-1 border-b sm:border-none border-slate-700 font-mono cursor-pointer shadow dark:bg-gray-900 bg-gray-700 dark:hover:bg-gray-950 hover:bg-gray-800 sm:rounded-lg rounded-t-lg"
        >
          English
        </Link>
        <Link
