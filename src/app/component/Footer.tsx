...
export default function Footer() {
  return (
    <div className="z-10 opacity-95 py-auto h-14 text-center dark:bg-slate-800 dark:bg-opacity-60 bg-slate-500 w-full shadow-sm shadow-slate-700 flex justify-center items-center">
