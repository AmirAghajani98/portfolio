...
export default function HeroSection() {
  return (
    <section className="relative font-sans w-full bg-slate-400 projectback sm:py-40 py-16 overflow-hidden">
      <div
      ...
      <div className="w-full h-screen">
        <div className="mx-auto sm:w-[62%] w-[90%] sm:px-6 relative z-10">
          <div className="pt-12 md:pb-10 md:pt-10">
            <div className="text-center md:pb-4">
              ...
              <div className="mx-auto max-w-3xl sm:mt-20">
                <p
                  className="mb-2 sm:mb-4 text-base sm:text-xl text-gray-900 dark:text-gray-300"
                  data-aos="zoom-y-out"
                  data-aos-delay={300}
                >
                  Design, Launch, and Grow Your Website with a Persian-Speaking
                  Web Expert <br /> Built for Iranian Businesses in Australia.
                </p>
                <span className="mb-8 sm:mb-0  text-base sm:text-xl text-gray-900 dark:text-gray-300 font-sans font-semibold">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full sm:mt-20 sm:pt-20 relative z-10">
        <div className="sm:flex justify-between items-center w-full">
          <div className="text-center md:text-left sm:w-1/2 sm:mt-10">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-400 mb-8">
              ...
              with <span className="font-semibold">4+ years of experience</span>
