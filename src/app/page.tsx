...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="sm:py-10 z-10 dark:z-10 sm:flex w-[86%] dark:text-slate-100 text-[#121a23] dark:bg-slate-700 bg-slate-500 dark:bg-opacity-10 bg-opacity-70 sm:text-justify text-start p-8 rounded-3xl mx-auto shadow-lg shadow-slate-600 border border-slate-400 dark:shadow-slate-900 dark:border-slate-800">
